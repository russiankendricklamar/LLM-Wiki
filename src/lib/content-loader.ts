...
const SECTION_LABELS: Record<string, Record<'en' | 'ru', string>> = {
  ...
  'cs':              { en: 'Computer Science', ru: 'Computer Science' },
...
const CATEGORY_LABELS: Record<string, Record<'en' | 'ru', string>> = {
  ...
  'Math Foundations':             { en: 'Foundations', ru: 'Основания' },
  ...
  'Signal Processing':            { en: 'Signal Processing', ru: 'Обработка сигналов' },
  'Обработка сигналов':           { en: 'Signal Processing', ru: 'Обработка сигналов' },
  ...
  'Advanced Theory':              { en: 'Advanced Theory', ru: 'Продвинутая теория' },
...
const SUBSECTION_LABELS: Record<string, Record<string, Record<'en' | 'ru', string>>> = {
  ...
  'ai-theory': {
    'algorithms':       { en: 'Algorithms',             ru: 'Алгоритмы' },
  ...
  'cs': {
    'crypto':  { en: 'Cryptography',       ru: 'Криптография' },
    'systems': { en: 'Systems & Networks', ru: 'Системы и сети' },
    'theory':  { en: 'CS Theory',          ru: 'Теоретическая CS' },
  },
  'physics': {
    ...
    'gravity':     { en: 'Gravity',           ru: 'Гравитация' },
    'holography':  { en: 'Holography',        ru: 'Голография' },
    'theoretical': { en: 'Advanced Theory',   ru: 'Продвинутая теория' },
  },
  'finance': {
    'defi':           { en: 'DeFi',                        ru: 'DeFi' },
    'derivatives':    { en: 'Derivatives',                 ru: 'Деривативы' },
  ...
  'math': {
    'advanced':              { en: 'Advanced Math',          ru: 'Продвинутая математика' },
    'advanced-analysis':     { en: 'Advanced Analysis',      ru: 'Продвинутый анализ' },
    'algebra':               { en: 'Algebra',                ru: 'Алгебра' },
    'analysis':              { en: 'Analysis',               ru: 'Анализ' },
    'analysis-geometry':     { en: 'Analysis & Geometry',    ru: 'Анализ и геометрия' },
    'applied-probability':   { en: 'Applied Probability',    ru: 'Прикладная вероятность' },
    'approximation':         { en: 'Approximation Theory',   ru: 'Теория приближений' },
    'asymptotic-stats':      { en: 'Asymptotic Statistics',  ru: 'Асимптотическая статистика' },
    'control':               { en: 'Control Theory',         ru: 'Теория управления' },
    'differential':          { en: 'Differential Equations', ru: 'Дифференциальные уравнения' },
    'foundations':           { en: 'Foundations',            ru: 'Основания' },
    'functional-analysis':   { en: 'Functional Analysis',    ru: 'Функциональный анализ' },
    'fundamentals':          { en: 'Fundamentals',           ru: 'Базовые понятия' },
    'geometry':              { en: 'Geometry',               ru: 'Геометрия' },
    'graphs':                { en: 'Graph Theory',           ru: 'Теория графов' },
    'learning-theory':       { en: 'Learning Theory',        ru: 'Теория обучения' },
    'linear-algebra':        { en: 'Linear Algebra',         ru: 'Линейная алгебра' },
    'measure-theory':        { en: 'Measure Theory',         ru: 'Теория меры' },
    'numerical':             { en: 'Numerical Methods',      ru: 'Численные методы' },
    'optimization':          { en: 'Optimization',           ru: 'Оптимизация' },
    'probability':           { en: 'Probability',            ru: 'Теория вероятностей' },
    'signal-processing':     { en: 'Signal Processing',      ru: 'Обработка сигналов' },
    'statistical-learning':  { en: 'Statistical Learning',   ru: 'Статистическое обучение' },
