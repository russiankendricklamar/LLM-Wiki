...
export const sabrModelMarkdownEn = `
# SABR Model
...
A simplified implementation of the SABR implied volatility (Hagan's formula):
...
The SABR model is famous for its ability to fit the market "smile". Below is a typical smile where implied volatility varies with the strike price.
...
export const sabrModelMarkdownRu = `
# Модель SABR
...
Упрощенная реализация вмененной волатильности SABR (формула Хагана):
...
Модель SABR знаменита своей способностью «подстраиваться» под рыночную улыбку. Ниже представлен типичный график, где вмененная волатильность меняется в зависимости от цены страйк.
...
export const mockNavigationRu = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Модель SABR", href: "/finance/sabr-model" },
    ],
  },
];
...
export const mockNavigationEn = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "SABR Model", href: "/finance/sabr-model" },
    ],
  },
];
