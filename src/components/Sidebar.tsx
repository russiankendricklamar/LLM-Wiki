...
import { FileText, ChevronDown, ChevronRight, UserCircle2, FolderGit2, Network } from 'lucide-react';
    ...
    <aside className={cn("w-64 shrink-0 border-r border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/50 h-full overflow-y-auto", className)}>
      <div className="p-4">
        <div className="mb-4 flex flex-col gap-0.5">
          ...
          >
            <UserCircle2 className="w-4 h-4 opacity-70 shrink-0" />
          ...
          >
            <FolderGit2 className="w-4 h-4 opacity-70 shrink-0" />
          ...
          >
            <Network className="w-4 h-4 opacity-70 shrink-0" />
