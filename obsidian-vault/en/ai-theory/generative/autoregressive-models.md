...
- **Causal [[attention-mechanisms|Attention]] (Transformers):** Self-[[attention-mechanisms|attention]] layers use a lower-triangular mask to prevent positions from attending to future tokens.
