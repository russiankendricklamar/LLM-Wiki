...
- **Irreducible [[shannon-entropy|entropy]]:** As $N, D \to \infty$, loss approaches irreducible [[shannon-entropy|entropy]] $L_\infty > 0$ — the true [[shannon-entropy|entropy]] of natural language.
