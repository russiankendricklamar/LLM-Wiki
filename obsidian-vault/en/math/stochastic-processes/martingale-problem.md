...
Thus any weak solution of the [[stochastic-differential-equations|SDE]] solves the martingale problem for $(L, \nu)$, and conversely, any solution to the martingale problem yields a weak solution. **Weak existence and uniqueness in law for the [[stochastic-differential-equations|SDE]] are equivalent to well-posedness of the martingale problem.**
...
The martingale problem formulation avoids several difficulties inherent in the pathwise [[stochastic-differential-equations|SDE]] approach:
