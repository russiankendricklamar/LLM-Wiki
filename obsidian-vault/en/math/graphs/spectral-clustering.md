...
### Graph [[spectral-graph-theory|Laplacian]]
Given an affinity matrix $W$ and degree matrix $D$, the unnormalized graph [[spectral-graph-theory|Laplacian]] is:
$L = D - W$
