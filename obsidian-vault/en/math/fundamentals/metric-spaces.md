...
1.  **[[manifold-learning|Manifold]] Learning**: In Deep Learning, we assume high-dimensional data (like photos) actually lies on a lower-dimensional, curved **[[manifold-learning|Manifold]]**. Algorithms like t-SNE or UMAP use topology to "unroll" this manifold.
