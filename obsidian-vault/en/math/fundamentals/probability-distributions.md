...
- **[[shannon-entropy|Entropy]]**: Distributions like the Uniform (maximum uncertainty) or Normal (maximum [[shannon-entropy|entropy]] for a given variance) play key roles in [[information-theory-basics|Information Theory]].
