...
- **Local Maximum:** $H$ is Negative Definite ($H \prec 0$). All [[spectral-theory-operators|eigenvalues]] are strictly negative.
- **Saddle Point:** $H$ is Indefinite (has both positive and negative [[spectral-theory-operators|eigenvalues]]).
