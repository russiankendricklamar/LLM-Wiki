...
- **The Solution**: Use **Gauge Equivariance**. The network is designed so that its output is independent of the local coordinate "gauge" chosen at each point. This requires weights to be constrained by representations of the [[lie-groups-algebras|Lie Group]] of the [[manifold-learning|manifold]].
