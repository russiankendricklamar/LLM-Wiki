...
- **[[shannon-entropy|Entropy]] Method (Guo-Papanicolaou-Varadhan)**: Uses the relative [[shannon-entropy|entropy]] between the true particle distribution and the local Gibbs measure to prove convergence.
