...
[[shiryaev-stochastic-finance|Shiryaev]] (Vol. 2, Ch. VIII, §4) devotes a separate section to this, focusing on **one-factor Gaussian models** — Vasicek and Hull-White — where the rate evolves as an Ornstein-Uhlenbeck process and admits closed-form bond-option formulas.
