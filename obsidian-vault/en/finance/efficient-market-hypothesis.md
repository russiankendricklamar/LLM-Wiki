...
[[shiryaev-stochastic-finance|Shiryaev]] uses EMH in Volume 1, Chapter I as a **historical bridge** between the descriptive economic tradition and the mathematical one: the "random walk" hypothesis of prices, which Bachelier already formalized, is the mathematical consequence of EMH. The modern martingale approach via [[ftap-first-fundamental-theorem|FTAP]] is its probability-theoretic generalization.
