...
Each [[inference-serving|GPU]] has a full copy of the model. The dataset is split, and each [[inference-serving|GPU]] processes a different batch.
- **Problem**: Model must fit in one [[inference-serving|GPU]]. 
