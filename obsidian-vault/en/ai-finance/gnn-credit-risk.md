...
GAT replaces uniform aggregation with learned [[attention-mechanisms|attention]] weights. For node $i$, the [[attention-mechanisms|attention]] coefficient toward neighbour $j$ is:
