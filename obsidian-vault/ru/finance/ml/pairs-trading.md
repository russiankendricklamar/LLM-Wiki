...
Симулированный z-score коинтегрированного спреда во времени с порогами входа (±2), выхода (±0.5) и стоп-лосса (±3.5). Спред возвращается к нулю в большинстве случаев в пределах периода полураспада.
...
```chart
{
  ...
  "lines": [
    {"dataKey": "zscore",   "stroke": "#3b82f6", "name": "Z-score спреда"},
    {"dataKey": "entry_hi", "stroke": "#10b981", "name": "Вход +2σ"},
    {"dataKey": "entry_lo", "stroke": "#10b981", "name": "Вход −2σ"},
    {"dataKey": "stop_hi",  "stroke": "#ef4444", "name": "Стоп +3.5σ"},
    {"dataKey": "stop_lo",  "stroke": "#ef4444", "name": "Стоп −3.5σ"}
  ]
}
```
