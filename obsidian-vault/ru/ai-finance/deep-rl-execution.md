...
- **Финансы:** [[optimal-execution]] — классическая теория исполнения (Алмгрен-Крисс, Гамильтон-Якоби-Беллман), оптимальное расписание, модель рыночного воздействия.
- **AI:** [[reinforcement-learning]] — общее обучение с подкреплением, MDP, Q-learning, policy gradient, PPO/SAC; математический фреймворк, который адаптируется к исполнению.

## Связанные темы

[[optimal-execution]] — классический фреймворк включая Алмгрена–Крисса и формулировки Гамильтона–Якоби–Беллмана

[[reinforcement-learning]] — общая теория RL и алгоритмов, применяемых здесь
