...
- **Nyquist**: AI-native рабочее пространство для финансового анализа. Объединяет данные рынка в реальном времени, QuantLib-вычисления и помощь [[llm|LLM]] в единой терминальной среде. Stack: Python, TypeScript, FastAPI, Claude.
...
- **[[llm|LLM]] Wiki**: Персональная база знаний по ИИ, количественным финансам и квантовой физике — этот сайт.
