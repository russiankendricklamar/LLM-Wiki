...
**PPO** — наиболее широко применяемый алгоритм policy gradient и основа [[rlhf|RLHF]]-обучения больших языковых моделей. Предложен Schulman et al. (2017): обеспечивает стабильное on-policy обучение, ограничивая изменение политики за одно обновление без вычислительных затрат методов второго порядка.
