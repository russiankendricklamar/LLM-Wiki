...
В [[rlhf|RLHF]] мы максимизируем вознаграждение $r(x, y)$, стараясь не уходить далеко от референсной модели $\pi_{ref}$:
...
## Сравнение: DPO vs. [[rlhf|RLHF]]

| Характеристика | [[rlhf|RLHF]] (PPO) | DPO |
|---|---|---|
